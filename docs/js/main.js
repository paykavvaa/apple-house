document.addEventListener('DOMContentLoaded', function() {
    ...
    const init = () => {
        ...
        const addScrollAnimationClasses = () => {
            document.querySelectorAll('.spec-card, .advantage-card, .gallery-item, .tech-image, .about-image, .certificate-banner')
                .forEach(el => {
        ...
        ensureVisibility(); // Добавляем новую функцию
